...
BUILTIN: Dict[str, Dict[str, Any]] = {
    ...
    "binance_futures_btc_scalp_relaxed": {
        ...
        "scalp_flow_window_sec": 5,
        "scalp_pressure_window_sec": 15,
        "scalp_rsi_long_trigger": 65.0,
        "scalp_rsi_short_min": 40.0,
        "scalp_rsi_short_max": 85.0,
        "scalp_use_rsi_cross": False,
        "scalp_require_reversal_candle": False,
        "scalp_imbalance_threshold": 0.03,
        "scalp_trade_pressure_threshold": 0.08,
        "scalp_max_spread_bps": 12.0,
        "entry_use_ioc": True,
        "exit_use_ioc": True,
        "ioc_price_pad_bps": 2.0,
        "ioc_max_chase_bps": 15.0,
        "max_account_exposure_frac": 1.10,
        "max_total_exposure_frac": 1.10,
    },
